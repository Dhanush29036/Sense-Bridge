    ...
    return (
        <AuthLayout>
            <div className="auth-card">
                <h1 style={{ fontSize: '1.4rem', fontWeight: 800, marginBottom: 4 }}>Welcome back</h1>
                <p style={{ color: 'var(--text-muted)', fontSize: '0.82rem', marginBottom: '1.75rem' }}>
                    Sign in to access your assistive profile
                </p>
                ...
                <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.82rem', color: 'var(--text-muted)' }}>
                    ...
                    <Link to="/register" style={{ color: 'var(--color-accent)', fontWeight: 700 }}>Create one</Link>
                </p>
            </div>
        </AuthLayout>
    );
